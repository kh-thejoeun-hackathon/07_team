...
| 이름 | 담당 |
| --- | --- |
| 한정웅 | 앱이 작동하는 기능과 일본어 문장 데이터 관리 |
| 마정현 | 화면 디자인과 사용하기 쉬운 화면 구성 |
...
- React 18: 여러 화면을 만들고 화면을 전환하는 데 사용
- JavaScript: 버튼 동작과 상황별 문장 선택 기능 구현
- JSX: React에서 화면 내용을 작성하는 문법
- Vite: 프로젝트를 실행하고 빌드하는 도구
- CSS: 색상, 카드, 글자, 모바일 화면 디자인
- Web Speech API: 일본어 문장을 소리 내어 읽어주는 기능
